...
const price = property.price.toLocaleString("en-NG", {
    style: "currency",
    currency: "NGN",
...
// const amenities = property.amenities ? property.amenities.flatMap(({ amenities }) => amenities).map((item) => item.text) : [];
const amenities = "Please Contact us for more Information."
