...
const Footer = () => {
    return (
   <Box backgroundColor="orange.600">
    <Box 
    maxWidth="1200px" 
    margin="0 auto"
    paddingY="3rem"
    ...
    <Box backgroundColor="orange.800" display="flex" padding="2rem" justifyContent="center" alignItems="center" flexDirection="column" color="white">
        <Box display="flex" gap="0.5rem" alignItems="center">
            <HiHomeModern/> 
            <Text fontSize="lg" fontWeight="black">KpREALTORS</Text> 
        </Box>
        <Text marginTop="1rem" fontSize="xs" textAlign="center">All rights reserved- Copyright KpREALTOR</Text> 
    </Box>
   </Box>
