            ...
            <Box width="100%" padding="2rem" borderRadius="sm" backgroundColor="white" color="gray.700"> 
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <FormControl >
                       ...
                       <Flex gap={{base: "0", sm:"1rem"}} flexDirection={{base: "colomn", sm:"row"}}
                       >
                       ...
                       <Checkbox marginTop="1.3rem" id="ndpr" type="checkbox" placeholder="NDPR" {...register("ndpr", {required: true})}>I consent to having this website store my submitted info</Checkbox>  
                       {errors.ndpr && (
                            <Text fontSize="xs" color="red.400">
                            {errors.ndpr.type}
                        </Text>
                    ...
                    <Button type="submit" colorScheme="orange" width="100%" fontSize="xl" padding="2rem" marginTop="2rem">Download Now</Button>
                </form>
            </Box>
    );
}
